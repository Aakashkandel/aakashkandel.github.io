...
import image1 from '../Assets/images/git.png';
import image2 from '../Assets/images/responsive.png';

export default function Skill() {
    return (
        <>
            <div class=" " id="skill">
                <section class="py-2 max-screen   sm:py-12 ">
                    <div class="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
                        <div class="text-center">
                            <h2 class="text-3xl font-bold leading-tight text-secondary sm:text-4xl xl:text-5xl mb-6">Explore My Skillset</h2>
                            <p class="mb-4 text-tertiary">"Experienced Web Developer with expertise in following Skills"</p>
